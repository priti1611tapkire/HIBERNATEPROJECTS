...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory()
	{
		...
		if(sf==null) {
			...
			m.put(Environment.URL, "jdbc:mysql://localhost:3306/hibernateonetomanyuninew12");
			...
			MetadataSources mds=new MetadataSources(registry).addAnnotatedClass(Customer.class).addAnnotatedClass(CustomerOrder.class);
