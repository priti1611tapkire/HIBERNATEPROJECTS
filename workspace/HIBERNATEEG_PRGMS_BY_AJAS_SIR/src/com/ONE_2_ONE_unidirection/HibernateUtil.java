...
private static StandardServiceRegistry registry=null;
	...
	public static SessionFactory getSessionFactory()
	{
		...
		if(sf==null) {
			...
			m.put(Environment.URL, "jdbc:mysql://localhost:3306/hibernateonetouninew12");
			...
			MetadataSources mds=new MetadataSources(registry).addAnnotatedClass(Person.class).addAnnotatedClass(Passport.class);
