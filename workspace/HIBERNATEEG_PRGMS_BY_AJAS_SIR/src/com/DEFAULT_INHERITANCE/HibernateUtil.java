...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory()
	{
		...
		if(sf==null) {
			...
			m.put(Environment.URL, "jdbc:mysql://localhost:3306/hibernateinheritancenew12");
			...
			MetadataSources mds=new MetadataSources(registry).addAnnotatedClass(SBI.class).addAnnotatedClass(HDFC.class).addAnnotatedClass(RBI.class);
