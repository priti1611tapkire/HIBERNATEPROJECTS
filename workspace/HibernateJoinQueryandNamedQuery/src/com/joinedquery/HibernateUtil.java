...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory(){
		...
		if(sf==null){
			...
			m.put(Environment.URL, "jdbc:mysql://localhost:3306/hibernatepractise14");
			...
			MetadataSources mds=new MetadataSources(registry).addAnnotatedClass(Staff_table.class).addAnnotatedClass(Payment_table.class);
