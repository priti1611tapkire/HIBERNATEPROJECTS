...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory(){
		...
		if(sf==null){
			...
			m.put(Environment.URL, "jdbc:mysql://localhost:3306/hibernatepractise1");
			...
			MetadataSources mds=new MetadataSources(registry).addAnnotatedClass(PersonalDetails.class);
