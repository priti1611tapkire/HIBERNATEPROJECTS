...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory(){
		...
		m.put(Environment.URL, "jdbc:mysql://localhost:3306/MypractiseBasicQuery");
		...
		MetadataSources mds=new MetadataSources(registry).addAnnotatedClass(Customers.class);
