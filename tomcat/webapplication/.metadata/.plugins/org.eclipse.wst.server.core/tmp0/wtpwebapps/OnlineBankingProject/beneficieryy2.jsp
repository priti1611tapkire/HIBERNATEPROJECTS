<%@page import="com.dao.PersonInfo"%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" id="logo" >
			<tr>			
				<td width="33%" align="center" valign="top"><a href="beneficiery.jsp"><img src="add.jpg" alt="ADD" width="500" height="55" border="0" /></a></td>
				<td width="33%" align="center" valign="top"><a href=""><img src="modify.jpg" alt="MODIFY" width="500" height="55" border="0" /></a></td>
				<td width="33%" align="center" valign="top"><a href=""><img src="remove.jpg" alt="REMOVE" width="500" height="55" border="0" /></a></td>
